...
// What is cow and why static has ' this front of it
}
...
#[allow(clippy::enum_variant_names)] // What does this do ?
#[derive(CandidType, Deserialize, Clone)]
...
// Why does a has ' front of it What is the difference
// between &a -- &'a
